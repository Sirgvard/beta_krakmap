...
function itemDetailMap(json){
    ...
    var map = new google.maps.Map(mapElement, mapOptions);
    if( json.type ) var icon = '<img src="/assets/icons/spots/' + json.type +  '.png">';
    else icon = '';
    ...
    visibleItemsArray.push(
        '<li>' +
            '<div class="item" id="' + json.data[a].id + '">' +
                '<a target="_blank" href="/spot/' + json.data[a].objectId + '" class="image">' +
                    '<div class="inner">' +
                ...
                '</a>' +
                '<div class="wrapper">' +
                    '<a target="_blank" href="/spot/' + json.data[a].objectId + '" id="' + json.data[a].id + '"><h3>' + json.data[a].title + '</h3></a>' +
